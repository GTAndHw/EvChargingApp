...
<html>
<head>
    <title>BBC Ev Charging App</title>
    <style>
        body { font-family: Arial, sans-serif; text-align: center; margin-top: 50px; }
        form { display: inline-block; text-align: left; }
...
<body>
    ...
    <form method="post" action="/step2">
        <label>Would you like to choose your car from our car library?</label>
        <select name="choice">
            <option value="L">Library</option>
            <option value="B">Scan for a car</option>
        </select>
...
def confirm_car():
    ...
    return render_template_string(result_template, message=f"You have chosen the {car_model}")
